...
use Ingrid\MagazineBundle\Entity\Issue;
use Ingrid\MagazineBundle\Form\IssueType;
...
class IssueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IngridMagazineBundle:Issue')->findAll();
     ...
     * @Method("POST")
     * @Template("IngridMagazineBundle:Issue:new.html.twig")
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IngridMagazineBundle:Issue')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IngridMagazineBundle:Issue:edit.html.twig")
     */
