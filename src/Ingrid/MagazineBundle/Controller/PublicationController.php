...
namespace Ingrid\MagazineBundle\Controller;
...
use Ingrid\MagazineBundle\Entity\Publication;
use Ingrid\MagazineBundle\Form\PublicationType;
...
class PublicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('IngridMagazineBundle:Publication')->findAll();
     ...
     * @Method("POST")
     * @Template("IngridMagazineBundle:Publication:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IngridMagazineBundle:Publication')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IngridMagazineBundle:Publication:edit.html.twig")
     */
